...
---
# 🚀 `/sprint1` Workflow (Awal Sprint)

Gunakan workflow ini untuk mengubah ide menjadi rencana sprint (Parent Sprint).

## 📋 Manifest
- **Input**: `docs/specs/.../spec.md`
- **Output**: `docs/dev/sprints/sprintX_0_parent.md`
- **Next Step**: `/sprintmicro`
...
### 2. Cek Konteks (Manual)
Sebelum membuat rencana, pastikan Anda memahami:
- **Architecture**: `docs/architecture/ARCHITECTURE.md`
- **Existing Code**: Cek kode yang ada secara manual.
- **Test Patterns**: Lihat folder `tests/` untuk contoh pengujian.
...
| `/agent-detail` | Add AI-optimized execution details |
