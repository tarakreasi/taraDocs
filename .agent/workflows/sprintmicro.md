...
---
# 🧩 `/sprintmicro` Workflow (Pecah Tugas)

Gunakan workflow ini untuk memecah Parent Sprint menjadi **Atomic Sprint**.

## 📋 Manifest
- **Input**: Parent Sprint
- **Output**: `sprintX_Y_Z.md`
- **Next Step**: `/sprintdetail`
...
5.  **Context Grounding**: Always define the Project Root explicitly in the generated sprint file so the AI Executor knows its CWD.
...
- `## 🌐 EXECUTION CONTEXT` (Explicitly state Project Root as CWD)
